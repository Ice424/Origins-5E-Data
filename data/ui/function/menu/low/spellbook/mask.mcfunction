...
execute if entity @p[tag=xp_xp] run data modify storage ui mask insert 0 value {Slot: 37b, id:"minecraft:stick", "components": {"custom_model_data": 38, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"none\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"xp_xp\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!xp_xp] run data modify storage ui mask insert 0 value {Slot: 37b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 38, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"xp_xp\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
