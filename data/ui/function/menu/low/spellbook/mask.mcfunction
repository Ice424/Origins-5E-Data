...
execute if entity @p[tag=falldmg_15] run data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:stick", "components": {"custom_model_data": 10, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"15% less fall damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!falldmg_15] run data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 10, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=falldmg_25] run data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:stick", "components": {"custom_model_data": 11, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"25% less fall damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!falldmg_25] run data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 11, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=falldmg_5] run data modify storage ui mask insert 0 value {Slot: 11b, id:"minecraft:stick", "components": {"custom_model_data": 12, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"5% less fall damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!falldmg_5] run data modify storage ui mask insert 0 value {Slot: 11b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 12, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=firedmg_15] run data modify storage ui mask insert 0 value {Slot: 12b, id:"minecraft:stick", "components": {"custom_model_data": 13, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"15% less fire damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!firedmg_15] run data modify storage ui mask insert 0 value {Slot: 12b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 13, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=firedmg_25] run data modify storage ui mask insert 0 value {Slot: 13b, id:"minecraft:stick", "components": {"custom_model_data": 14, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"25% less fire damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!firedmg_25] run data modify storage ui mask insert 0 value {Slot: 13b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 14, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=firedmg_5] run data modify storage ui mask insert 0 value {Slot: 14b, id:"minecraft:stick", "components": {"custom_model_data": 15, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"5% less fire damage\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!firedmg_5] run data modify storage ui mask insert 0 value {Slot: 14b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 15, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=hunger_gain_2] run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 22, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"You gain 6 more hunger hunches and 2 more points of saturation\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Increased food points\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!hunger_gain_2] run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 22, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Increased food points\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!hunger_gain_3] run data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 23, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Increased food points\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=hunger_loss_15] run data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:stick", "components": {"custom_model_data": 24, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"hunger is lost 15% slower\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!hunger_loss_15] run data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 24, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=hunger_loss_25] run data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:stick", "components": {"custom_model_data": 25, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"hunger is lost 25% slower\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!hunger_loss_25] run data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 25, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=hunger_loss_5] run data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:stick", "components": {"custom_model_data": 26, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"hunger is lost 5% slower\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=swim_speed_15] run data modify storage ui mask insert 0 value {Slot: 31b, id:"minecraft:stick", "components": {"custom_model_data": 32, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"15% increase in swim speed\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!swim_speed_15] run data modify storage ui mask insert 0 value {Slot: 31b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 32, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=swim_speed_25] run data modify storage ui mask insert 0 value {Slot: 32b, id:"minecraft:stick", "components": {"custom_model_data": 33, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"25% increase in swim speed\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!swim_speed_25] run data modify storage ui mask insert 0 value {Slot: 32b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 33, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=swim_speed_5] run data modify storage ui mask insert 0 value {Slot: 33b, id:"minecraft:stick", "components": {"custom_model_data": 34, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"5% increase in swim speed\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=xp_xp] run data modify storage ui mask insert 0 value {Slot: 34b, id:"minecraft:stick", "components": {"custom_model_data": 35, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"none\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"xp\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!xp_xp] run data modify storage ui mask insert 0 value {Slot: 34b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 35, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"xp\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=xp_gain_15] run data modify storage ui mask insert 0 value {Slot: 35b, id:"minecraft:stick", "components": {"custom_model_data": 36, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"15% increase to xp gain\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!xp_gain_15] run data modify storage ui mask insert 0 value {Slot: 35b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 36, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=xp_gain_25] run data modify storage ui mask insert 0 value {Slot: 36b, id:"minecraft:stick", "components": {"custom_model_data": 37, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"25% increase to xp gain\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!xp_gain_25] run data modify storage ui mask insert 0 value {Slot: 36b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 37, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=xp_gain_5] run data modify storage ui mask insert 0 value {Slot: 37b, id:"minecraft:stick", "components": {"custom_model_data": 38, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"5% increase to xp gain\"}"],custom_name:"{\"color\":\"dark_gray\",\"italic\":false,\"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!xp_gain_5] run data modify storage ui mask insert 0 value {Slot: 37b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 38, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
