...
execute if entity @p[tag=!fall_dmg_1, tag=!fall_dmg_3, tag=!fall_dmg_5] run data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 12, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Fall damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!fire_dmg_1, tag=!fire_dmg_3, tag=!fire_dmg_5] run data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 15, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Fire damage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!health_1, tag=!health_2, tag=!health_3, tag=!health_4, tag=!health_5] run data modify storage ui mask insert 0 value {Slot: 11b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 20, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Increased health\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!hunger_gain_1, tag=!hunger_gain_3, tag=!hunger_gain_5] run data modify storage ui mask insert 0 value {Slot: 12b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 23, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Increased food points\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!hunger_loss_1, tag=!hunger_loss_3, tag=!hunger_loss_5] run data modify storage ui mask insert 0 value {Slot: 13b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 26, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Hunger loss\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!luck_1, tag=!luck_2, tag=!luck_3, tag=!luck_4, tag=!luck_5] run data modify storage ui mask insert 0 value {Slot: 14b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 31, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Luck\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!swim_speed_1, tag=!swim_speed_3, tag=!swim_speed_5] run data modify storage ui mask insert 0 value {Slot: 15b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 34, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Swim speed\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!xp_gain_1, tag=!xp_gain_3, tag=!xp_gain_5] run data modify storage ui mask insert 0 value {Slot: 16b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 37, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=!] run data modify storage ui mask insert 0 value {Slot: 17b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 37, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Xp gain\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
