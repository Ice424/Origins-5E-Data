...
function ui:minecart/if_player_selector {selector:"tag=!fly", cmd:'data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 106, custom_name:\'{"color":"dark_gray","italic":false, "text":"Levitation"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
...
function ui:minecart/if_player_selector {selector:"tag=!lightning", cmd:'data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 107, custom_name:\'{"color":"dark_gray","italic":false, "text":"Summon storms"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=slow_fall", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:stick", "components": {"custom_model_data": 108, lore:[\'{"color":"gray","italic":false,"text":"Crouch mid air gives slow falling"}\'],custom_name:\'{"color":"#5b6ee1","italic":false,"text":"Glide"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!slow_fall", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 108, custom_name:\'{"color":"dark_gray","italic":false, "text":"Glide"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=wither", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 109, lore:[\'{"color":"gray","italic":false,"text":"Inflict wither to mobs within fov"}\'],custom_name:\'{"color":"#5b6ee1","italic":false,"text":"Deteriorate"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!wither", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 109, custom_name:\'{"color":"dark_gray","italic":false, "text":"Deteriorate"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
...
function ui:minecart/if_player_selector {selector:"tag=!fireball", cmd:'data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 110, custom_name:\'{"color":"dark_gray","italic":false, "text":"Explosive Fireball"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
...
function ui:minecart/if_player_selector {selector:"tag=!glow", cmd:'data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 111, custom_name:\'{"color":"dark_gray","italic":false, "text":"Wizard\'s Knowledge"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
...
function ui:minecart/if_player_selector {selector:"tag=!ice", cmd:'data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 112, custom_name:\'{"color":"dark_gray","italic":false, "text":"Ice Walker"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
...
function ui:minecart/if_player_selector {selector:"tag=!push", cmd:'data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 113, custom_name:\'{"color":"dark_gray","italic":false, "text":"Force Push"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}
