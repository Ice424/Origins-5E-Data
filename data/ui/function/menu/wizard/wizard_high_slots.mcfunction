...
execute if entity @p[tag= !fireball] run summon armor_stand ~ 116 ~ {Tags: [randomizer], NoGravity: 1b}
execute if entity @p[tag= !ice] run summon armor_stand ~ 117 ~ {Tags: [randomizer], NoGravity: 1b}
