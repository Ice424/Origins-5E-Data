...
function ui:minecart/if_player_selector {selector:"tag=dash", cmd:'data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:stick", "components": {"custom_model_data": 81, lore:[\'{"color":"gray","italic":false,"text":"Get a 6 block dash, scales with momentum"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Dash"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!dash", cmd:'data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 81, custom_name:\'{"color":"dark_gray","italic":false, "text":"Dash"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=invisibility", cmd:'data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:stick", "components": {"custom_model_data": 82, lore:[\'{"color":"gray","italic":false,"text":"Use to get invisibility for 15 secs, 45 sec cooldown"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Vanish"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!invisibility", cmd:'data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 82, custom_name:\'{"color":"dark_gray","italic":false, "text":"Vanish"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=opportunist", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:stick", "components": {"custom_model_data": 83, lore:[\'{"color":"gray","italic":false,"text":"Double damage to enemies who have a negative potion effect or are below half health"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Opportunist"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!opportunist", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 83, custom_name:\'{"color":"dark_gray","italic":false, "text":"Opportunist"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=teleport", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 84, lore:[\'{"color":"gray","italic":false,"text":"Ability to teleport where you are looking"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Instant Transmission"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!teleport", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 84, custom_name:\'{"color":"dark_gray","italic":false, "text":"Instant Transmission"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=wall_climb", cmd:'data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:stick", "components": {"custom_model_data": 85, lore:[\'{"color":"gray","italic":false,"text":"Gain the ability to wall climb"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Wall Climb"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!wall_climb", cmd:'data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 85, custom_name:\'{"color":"dark_gray","italic":false, "text":"Wall Climb"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=blindness", cmd:'data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:stick", "components": {"custom_model_data": 86, lore:[\'{"color":"gray","italic":false,"text":"Ability to give blindness to anyone in 8 blocks for 5 seconds"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Smoke Bomb"}\', "minecraft:custom_data": {ui_item:{cmd:"function ui:menu/rogue/slot_select/open {predicate:86}"}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!blindness", cmd:'data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 86, custom_name:\'{"color":"dark_gray","italic":false, "text":"Smoke Bomb"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=fall_dmg", cmd:'data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:stick", "components": {"custom_model_data": 87, lore:[\'{"color":"gray","italic":false,"text":"No fall damage"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Feather Fall"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!fall_dmg", cmd:'data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 87, custom_name:\'{"color":"dark_gray","italic":false, "text":"Feather Fall"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=grapple_hook", cmd:'data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:stick", "components": {"custom_model_data": 88, lore:[\'{"color":"gray","italic":false,"text":"Made by finn_nerd, originally for Origins 1.20.1."}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Grappling Hook"}\', "minecraft:custom_data": {ui_item:{cmd:"function ui:menu/rogue/slot_select/open {predicate:88}"}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!grapple_hook", cmd:'data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 88, custom_name:\'{"color":"dark_gray","italic":false, "text":"Grappling Hook"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=stealth_bonus", cmd:'data modify storage ui mask insert 0 value {Slot: 26b, id:"minecraft:stick", "components": {"custom_model_data": 89, lore:[\'{"color":"gray","italic":false,"text":"Use ability to get speed 3 and strength 2"}\'],custom_name:\'{"color":"#403352","italic":false,"text":"Stealth affinity"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!stealth_bonus", cmd:'data modify storage ui mask insert 0 value {Slot: 26b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 89, custom_name:\'{"color":"dark_gray","italic":false, "text":"Stealth affinity"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:stick", "components": {"custom_model_data": 90, lore:['{"color":"gray","italic":false,"text":"Mobs take longer to aggro"}'],custom_name:'{"color":"#403352","italic":false,"text":"Evasion"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:stick", "components": {"custom_model_data": 91, lore:['{"color":"gray","italic":false,"text":"Your footsteps don\'t trigger skulk sensors"}'],custom_name:'{"color":"#403352","italic":false,"text":"Sneaky"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 11b, id:"minecraft:stick", "components": {"custom_model_data": 92, lore:['{"color":"gray","italic":false,"text":"You have 8 hearts"}'],custom_name:'{"color":"#403352","italic":false,"text":"Brittle"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 12b, id:"minecraft:stick", "components": {"custom_model_data": 93, lore:['{"color":"gray","italic":false,"text":"You have no name tag"}'],custom_name:'{"color":"#403352","italic":false,"text":"Off the Grid"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}
