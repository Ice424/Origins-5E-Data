...
execute if entity @p[tag=!block] run data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 94, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Unshakeable\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!damage] run data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 95, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Warrior's Defence\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!fire_res] run data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 96, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Born From Flame\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!fire_ring] run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 97, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Ring Of Fire\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!rage] run data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 98, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Warrior's Rage\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!stone] run data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 99, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Wall Of Stone\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!ground_pound] run data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 100, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Ground Pound\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!hook] run data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 101, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Chain Hook\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!knockback] run data modify storage ui mask insert 0 value {Slot: 26b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 102, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Heavy\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!shield] run data modify storage ui mask insert 0 value {Slot: 27b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 103, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Warrior's Protection\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=!thorns] run data modify storage ui mask insert 0 value {Slot: 28b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 104, custom_name:"{\"color\":\"gray\",\"italic\":false, \"text\":\"Barbed Armour\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
