...
function ui:minecart/if_player_selector {selector:"tag=block", cmd:'data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:stick", "components": {"custom_model_data": 93, lore:[\'{"color":"gray","italic":false,"text":"Become invincible for a short period"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Unshakeable"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!block", cmd:'data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 93, custom_name:\'{"color":"dark_gray","italic":false, "text":"Unshakeable"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=damage", cmd:'data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:stick", "components": {"custom_model_data": 94, lore:[\'{"color":"gray","italic":false,"text":"Take half damage"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Warrior\'s Defence"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!damage", cmd:'data modify storage ui mask insert 0 value {Slot: 19b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 94, custom_name:\'{"color":"dark_gray","italic":false, "text":"Warrior\'s Defence"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=fire_res", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:stick", "components": {"custom_model_data": 95, lore:[\'{"color":"gray","italic":false,"text":"Fire resistance"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Born From Flame"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!fire_res", cmd:'data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 95, custom_name:\'{"color":"dark_gray","italic":false, "text":"Born From Flame"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=fire_ring", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 96, lore:[\'{"color":"gray","italic":false,"text":"Able to create a ring of fire around yourself"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Ring Of Fire"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!fire_ring", cmd:'data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 96, custom_name:\'{"color":"dark_gray","italic":false, "text":"Ring Of Fire"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=rage", cmd:'data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:stick", "components": {"custom_model_data": 97, lore:[\'{"color":"gray","italic":false,"text":"When you rage, you get increased speed and damage for a short period"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Warrior\'s Rage"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!rage", cmd:'data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 97, custom_name:\'{"color":"dark_gray","italic":false, "text":"Warrior\'s Rage"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=stone", cmd:'data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:stick", "components": {"custom_model_data": 98, lore:[\'{"color":"gray","italic":false,"text":"Gain the ability to create a wall of stone"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Wall Of Stone"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!stone", cmd:'data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 98, custom_name:\'{"color":"dark_gray","italic":false, "text":"Wall Of Stone"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=ground_pound", cmd:'data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:stick", "components": {"custom_model_data": 99, lore:[\'{"color":"gray","italic":false,"text":"When you take fall damage you do a ground pound, the higher you fall, the more damage"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Ground Pound"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!ground_pound", cmd:'data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 99, custom_name:\'{"color":"dark_gray","italic":false, "text":"Ground Pound"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=hook", cmd:'data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:stick", "components": {"custom_model_data": 100, lore:[\'{"color":"gray","italic":false,"text":"Throws a hook at a target, pulling them towards you when it connects"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Chain Hook"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!hook", cmd:'data modify storage ui mask insert 0 value {Slot: 25b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 100, custom_name:\'{"color":"dark_gray","italic":false, "text":"Chain Hook"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=knockback", cmd:'data modify storage ui mask insert 0 value {Slot: 26b, id:"minecraft:stick", "components": {"custom_model_data": 101, lore:[\'{"color":"gray","italic":false,"text":"You have knockback resistance"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Heavy"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!knockback", cmd:'data modify storage ui mask insert 0 value {Slot: 26b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 101, custom_name:\'{"color":"dark_gray","italic":false, "text":"Heavy"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=shield", cmd:'data modify storage ui mask insert 0 value {Slot: 27b, id:"minecraft:stick", "components": {"custom_model_data": 102, lore:[\'{"color":"gray","italic":false,"text":"Able to deploy a shield that blocks projectiles"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Warrior\'s Protection"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!shield", cmd:'data modify storage ui mask insert 0 value {Slot: 27b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 102, custom_name:\'{"color":"dark_gray","italic":false, "text":"Warrior\'s Protection"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=thorns", cmd:'data modify storage ui mask insert 0 value {Slot: 28b, id:"minecraft:stick", "components": {"custom_model_data": 103, lore:[\'{"color":"gray","italic":false,"text":"Use ability to toggle thorns"}\'],custom_name:\'{"color":"#2c2d51","italic":false,"text":"Barbed Armour"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

function ui:minecart/if_player_selector {selector:"tag=!thorns", cmd:'data modify storage ui mask insert 0 value {Slot: 28b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 103, custom_name:\'{"color":"dark_gray","italic":false, "text":"Barbed Armour"}\', "minecraft:custom_data": {ui_item: {empty: 1b}}}}'}

data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:stick", "components": {"custom_model_data": 104, lore:['{"color":"gray","italic":false,"text":"Gain resistance 1"}'],custom_name:'{"color":"#2c2d51","italic":false,"text":"Warrior\'s Might"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:stick", "components": {"custom_model_data": 105, lore:['{"color":"gray","italic":false,"text":"Saturation"}'],custom_name:'{"color":"#2c2d51","italic":false,"text":"Nourished"}', "minecraft:custom_data": {ui_item: {empty: 1b}}}}
