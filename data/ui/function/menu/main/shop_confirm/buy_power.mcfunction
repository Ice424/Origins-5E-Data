...
$execute if score @p activated matches 0 if score @p cost matches 1 unless score @p predicate matches 44 unless score @p predicate matches 39 run power grant @p chill:$(path)
