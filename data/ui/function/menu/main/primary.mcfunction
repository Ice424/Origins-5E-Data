...
execute if score @p predicate matches 19 run power grant @p chill:class/cleric/special/summon/primary chill:primary


execute if score @p predicate matches 13 run scoreboard players set @p primary 13
execute if score @p predicate matches 13 run power grant @p chill:class/cleric/high/heal/primary chill:primary


execute if score @p predicate matches 38 run scoreboard players set @p primary 38
execute if score @p predicate matches 38 run power grant @p chill:class/fighter/high/arrows/primary chill:primary


execute if score @p predicate matches 39 run scoreboard players set @p primary 39
execute if score @p predicate matches 39 run power grant @p chill:class/fighter/high/overheal/primary chill:primary


execute if score @p predicate matches 40 run scoreboard players set @p primary 40
execute if score @p predicate matches 40 run power grant @p chill:class/fighter/high/powered/primary chill:primary


execute if score @p predicate matches 41 run scoreboard players set @p primary 41
