...
execute if score @p predicate matches 44 run scoreboard players set @p primary 44
execute if score @p predicate matches 44 run power grant @p chill:high/permeation/primary chill:primary
    
execute if score @p predicate matches 45 run scoreboard players set @p primary 45
execute if score @p predicate matches 45 run power grant @p chill:high/scan/primary chill:primary
...
execute if score @p predicate matches 77 run power grant @p chill:class/fighter/high/arrows/primary chill:primary
    
execute if score @p predicate matches 78 run scoreboard players set @p primary 78
execute if score @p predicate matches 78 run power grant @p chill:class/fighter/high/overheal/primary chill:primary
