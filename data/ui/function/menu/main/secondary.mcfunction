...
execute if score @p predicate matches 19 run power grant @p chill:class/cleric/special/summon/secondary chill:secondary


execute if score @p predicate matches 13 run scoreboard players set @p secondary 13
execute if score @p predicate matches 13 run power grant @p chill:class/cleric/high/heal/secondary chill:secondary


execute if score @p predicate matches 38 run scoreboard players set @p secondary 38
execute if score @p predicate matches 38 run power grant @p chill:class/fighter/high/arrows/secondary chill:secondary


execute if score @p predicate matches 39 run scoreboard players set @p secondary 39
execute if score @p predicate matches 39 run power grant @p chill:class/fighter/high/overheal/secondary chill:secondary


execute if score @p predicate matches 40 run scoreboard players set @p secondary 40
execute if score @p predicate matches 40 run power grant @p chill:class/fighter/high/powered/secondary chill:secondary


execute if score @p predicate matches 41 run scoreboard players set @p secondary 41
