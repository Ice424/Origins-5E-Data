...
execute if score @p predicate matches 58 run scoreboard players set @p secondary 58
execute if score @p predicate matches 58 run power grant @p chill:class/druid/special/freeze/secondary chill:secondary
    
execute if score @p predicate matches 59 run scoreboard players set @p secondary 59
execute if score @p predicate matches 59 run power grant @p chill:class/druid/special/sculk/secondary chill:secondary
...
execute if score @p predicate matches 86 run scoreboard players set @p secondary 86
execute if score @p predicate matches 86 run power grant @p chill:class/rogue/high/blindness/secondary chill:secondary
