...
execute if score @p predicate matches 43 run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 43, custom_name:"{\"color\":\"dark_purple\",\"italic\":false,\"text\":\"Primary\"}", "minecraft:custom_data": {ui_item: {cmd: "function ui:menu/main/primary"}}}}

execute if score @p predicate matches 43 run data modify storage ui mask insert 0 value {Slot: 23b, id:"minecraft:stick", "components": {"custom_model_data": 43, custom_name:"{\"color\":\"dark_purple\",\"italic\":false,\"text\":\"Secondary\"}", "minecraft:custom_data": {ui_item: {cmd: "function ui:menu/main/secondary"}}}}
