...
execute if entity @p[tag=!poison] run data modify storage ui mask insert 0 value {Slot: 24b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 62, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Decay Spell\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
