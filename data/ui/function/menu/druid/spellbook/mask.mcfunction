...
execute if entity @p[tag=animal_control] run data modify storage ui mask insert 0 value {Slot: 18b, id:"minecraft:stick", "components": {"custom_model_data": 56, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"Non-tameable mobs can be tamed and act as wolves using red dye on them\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Nature's Offence\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
execute if entity @p[tag=freeze] run data modify storage ui mask insert 0 value {Slot: 20b, id:"minecraft:stick", "components": {"custom_model_data": 58, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"Stop all mobs movement around you\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Freeze Life\"}", "minecraft:custom_data": {ui_item:{cmd:"function ui:menu/druid/slot_select/open {predicate:58}"}}}}
...
execute if entity @p[tag=sculk] run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:stick", "components": {"custom_model_data": 59, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"Hold sneak and ability to spread sculk to deal damage\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Fungi's Onslaught\"}", "minecraft:custom_data": {ui_item:{cmd:"function ui:menu/druid/slot_select/open {predicate:59}"}}}}

execute if entity @p[tag=!sculk] run data modify storage ui mask insert 0 value {Slot: 21b, id:"minecraft:iron_nugget", "components": {"custom_model_data": 59, custom_name:"{\"color\":\"dark_gray\",\"italic\":false, \"text\":\"Fungi's Onslaught\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

execute if entity @p[tag=speed] run data modify storage ui mask insert 0 value {Slot: 22b, id:"minecraft:stick", "components": {"custom_model_data": 60, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"You are faster when in water or on dirt\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Environmental Affinity\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
...
data modify storage ui mask insert 0 value {Slot: 9b, id:"minecraft:stick", "components": {"custom_model_data": 65, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"Standing near flowers heal\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Nature's Healing\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 10b, id:"minecraft:stick", "components": {"custom_model_data": 66, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"You have 9 hearts\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Brittle\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}

data modify storage ui mask insert 0 value {Slot: 11b, id:"minecraft:stick", "components": {"custom_model_data": 67, lore:["{\"color\":\"gray\",\"italic\":false,\"text\":\"Can't eat meat\"}"],custom_name:"{\"color\":\"#99e550\",\"italic\":false,\"text\":\"Vegetarian\"}", "minecraft:custom_data": {ui_item: {empty: 1b}}}}
